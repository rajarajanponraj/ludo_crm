                ...
                <div class="flex flex-col justify-center">
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <h1 class="text-3xl font-bold text-brandColor">
                                CRM Installer
                            </h1>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.admin')"
                                    />
                            ...
                            const stepActions = {
                                envDatabase: () => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["This application currently supports MySQL only."] });
                                    }
                                },
