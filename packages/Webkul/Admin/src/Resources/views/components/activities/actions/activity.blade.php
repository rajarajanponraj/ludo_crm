                    ...
                    >
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group class="!mb-0">
                                ...
                                <input type="hidden" name="location_lat" id="activity_create_location_lat">
                                <input type="hidden" name="location_lng" id="activity_create_location_lng">
                            </x-admin::form.control-group>
            ...
            methods: {
                ...
                getLocation() {
                    ...
                    navigator.geolocation.getCurrentPosition(
                        (position) => {
                            document.getElementById('activity_create_location_lat').value = position.coords.latitude;
                            document.getElementById('activity_create_location_lng').value = position.coords.longitude;
                            
                            // Optional: Fill text box
                            const locInput = document.getElementById('activity_create_location');
                            if (!locInput.value) {
